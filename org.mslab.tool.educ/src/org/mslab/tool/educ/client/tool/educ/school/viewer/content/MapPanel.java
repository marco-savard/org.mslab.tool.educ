...
class MapPanel extends SimplePanel {
	...
	public void init() {
		...
		_mapVisualization = new MapVisualization(data, options, "400px", "300px");
	...
	public void refresh() {
		if (_mapVisualization != null) {
			int height = Window.getClientHeight() - EducShell.HEADER_HEIGHT_PX - 200; 
			int width = ((2 * Window.getClientWidth()) / 3) - 150; 
